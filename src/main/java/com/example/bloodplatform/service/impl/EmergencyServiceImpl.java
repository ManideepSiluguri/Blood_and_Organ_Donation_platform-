...
import com.example.bloodplatform.exception.BadRequestException;
...
public class EmergencyServiceImpl implements EmergencyService {
    ...
    public EmergencyRequest claim(UUID id, String responder) {
        ...
        if ("RESPONDED".equalsIgnoreCase(ex.getStatus())) {
            throw new BadRequestException("EmergencyRequest is already RESPONDED and cannot be claimed again.");
        }
