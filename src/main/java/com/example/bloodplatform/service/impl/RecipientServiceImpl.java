...
public class RecipientServiceImpl implements RecipientService {
    ...
    @Autowired
    public RecipientServiceImpl(RecipientRepository recipientRepository) { this.recipientRepository = recipientRepository; }

    @Override
    public Recipient create(Recipient recipient) { return recipientRepository.save(recipient); }
    ...
    @Override
    public Page<Recipient> listByStatus(String status, Pageable pageable) {
